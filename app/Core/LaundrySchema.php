...
final class LaundrySchema
{
    ...
    public static function ensure(PDO $pdo): void
    {
        ...
        self::addColumnIfMissing($pdo, 'laundry_orders', 'group_reference_code', 'VARCHAR(40) NULL DEFAULT NULL AFTER reference_code');
        ...
        self::addColumnIfMissing($pdo, 'laundry_orders', 'track_machine_stage', 'VARCHAR(40) NULL DEFAULT NULL AFTER dryer_machine_id');
        self::addColumnIfMissing($pdo, 'laundry_orders', 'wash_rinse_minutes', 'INT NULL DEFAULT NULL AFTER track_machine_stage');
        self::addColumnIfMissing($pdo, 'laundry_orders', 'wash_rinse_machine_id', 'BIGINT UNSIGNED NULL DEFAULT NULL AFTER wash_rinse_minutes');
        self::addColumnIfMissing($pdo, 'laundry_orders', 'wash_rinse_started_at', 'DATETIME NULL DEFAULT NULL AFTER wash_rinse_machine_id');
        self::addColumnIfMissing($pdo, 'laundry_orders', 'wash_rinse_end_at', 'DATETIME NULL DEFAULT NULL AFTER wash_rinse_started_at');
        self::addColumnIfMissing($pdo, 'laundry_orders', 'drying_minutes', 'INT NULL DEFAULT NULL AFTER wash_rinse_end_at');
        self::addColumnIfMissing($pdo, 'laundry_orders', 'drying_machine_id', 'BIGINT UNSIGNED NULL DEFAULT NULL AFTER drying_minutes');
        self::addColumnIfMissing($pdo, 'laundry_orders', 'drying_started_at', 'DATETIME NULL DEFAULT NULL AFTER drying_machine_id');
